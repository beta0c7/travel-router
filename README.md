...
```bash
curl -L [https://raw.githubusercontent.com/beta0c7/travel-router/main/setup.sh](https://raw.githubusercontent.com/beta0c7/travel-router/main/setup.sh) | sudo bash